...
import com.example.perceptioncheck.databinding.SpellListItemBinding

class SpellListAdapter(private val onItemClicked: (SingleSpell)->Unit): ListAdapter<SingleSpell,SpellListAdapter.SpellViewHolder>(DiffCallBack) {
